...
ALTER TABLE loan_warehouse.borrowers
    ...
    EXPECT (credit_score IS NULL OR (credit_score >= 300 AND credit_score <= 850));

ALTER TABLE loan_warehouse.borrowers
    ADD CONSTRAINT borrowers_annual_income_positive
    EXPECT (annual_income IS NULL OR annual_income >= 0);
