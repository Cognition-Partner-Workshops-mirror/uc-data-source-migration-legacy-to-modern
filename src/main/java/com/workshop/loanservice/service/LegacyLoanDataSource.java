...
/**
 * Legacy data source implementation that reads from the denormalized CDW tables
 * where all columns are VARCHAR. Performs string-to-type conversion at read time.
 * Preserved from original LoanService for dual-read shadow comparison during
 * safe rollout of the modern schema.
 */
@Component
public class LegacyLoanDataSource implements LoanDataSource {
    ...
    public LegacyLoanDataSource(LegacyBorrowerRepository borrowerRepository,
    ...
    public List<LoanSummaryDto> getAllLoans() {
        // Build product lookup map for product description resolution
    ...
    // Convert legacy VARCHAR fields to proper types at read time.
    // =========================================================================

    /** Maps a legacy loan account + product to LoanSummaryDto with string-to-type conversion */
    ...
    /** Maps a legacy borrower entity to BorrowerDto */
    ...
    /** Maps a legacy payment entity to PaymentDto */
    ...
    /** Expand 3-letter loan status code to display string */
    ...
    /** Expand property type abbreviation to full description */
    ...
    /** Expand payment type code to display string */
    ...
    /** Expand payment status code to display string */
