...
/**
 * Modern data source implementation that reads from the normalized schema
 * with properly typed columns (LocalDate, BigDecimal, Long, enums).
 * No string-to-type conversion needed — entities already have correct Java types.
 */
@Component
@Transactional(readOnly = true)
public class ModernLoanDataSource implements LoanDataSource {

    private final BorrowerRepository borrowerRepository;
    private final LoanAccountRepository loanAccountRepository;
    private final PaymentRepository paymentRepository;

    public ModernLoanDataSource(BorrowerRepository borrowerRepository,
    ...
    // =========================================================================
    // DTO MAPPING — entities already have proper types, no parsing needed.
    // =========================================================================
    ...
    private LoanSummaryDto toLoanSummary(LoanAccount acct) {
        ...
        // Numeric fields are already typed
