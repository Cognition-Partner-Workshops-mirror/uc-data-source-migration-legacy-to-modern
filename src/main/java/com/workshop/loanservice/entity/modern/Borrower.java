...
/**
 * Modern JPA entity for the borrowers table.
 * Uses proper typed columns (LocalDate, BigDecimal, Integer, enums)
 * instead of the legacy all-VARCHAR approach.
 */
@Entity
@Table(name = "borrowers")
public class Borrower {

    /** Status enum representing borrower lifecycle states */
    public enum Status {
        ACTIVE, INACTIVE
    }
